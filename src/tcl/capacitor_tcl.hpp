...
*/
#ifndef _CAPACITOR_TCL_H
#define _CAPACITOR_TCL_H

#if defined(ELECTROSTATICS)
#include "parser.hpp"

/** Implementation of the tcl-command <br>
    generate_potential_from_mesh  { \<last_ind_id\> \<e1\> \<num_iteration\> \<convergence\> \<relaxation\> \<area\> \<normal_components\> \<e_in/e_out\>  [\<ext_field\>] | iterate } 
